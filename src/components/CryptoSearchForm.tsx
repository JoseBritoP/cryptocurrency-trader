    ...
    <form onSubmit={handleSubmit}>
      <legend className="flex flex-col items-center justify-center gap-y-5" >
        ...
        <div className="flex flex-col gap-5 justify-evenly">
          ...
          <select name="currency" id="currency" value={pair.currency} onChange={handleChange} className="py-2 px-4 text-gray-700 rounded-md">
        ...
        <div className="flex flex-col gap-5 justify-evenly">
          ...
          <select name="cryptocurrency" id="cryptocurrency" value={pair.cryptocurrency} onChange={handleChange} className="py-2 px-4 text-gray-700 rounded-md">
            <option value="---"> -- Select the currency --</option>
        ...
        <button aria-label="Check currency" className="hover:bg-[#123866] bg-[#1458aa] transition-colors 300 ease-in-out py-2 px-4 rounded-md text-xl border-[1px] border-sky-600 uppercase mt-2 font-bold">Check currency</button>
      </legend>
    </form>
  )
}
